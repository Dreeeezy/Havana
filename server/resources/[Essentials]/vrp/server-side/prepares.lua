...
vRP.prepare("vRP/show_winrace","SELECT * FROM vrp_races WHERE raceid = @id ORDER BY points ASC LIMIT 13")
-----------------------------------------------------------------------------------------------------------------------------------------
-- PREPARE USERS
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.prepare("vRP/update_celular","UPDATE vrp_users SET phone = @phone WHERE id = @id")
-----------------------------------------------------------------------------------------------------------------------------------------
-- PREPARE BANK
-----------------------------------------------------------------------------------------------------------------------------------------
...
vRP.prepare("vRP/get_verificado","SELECT user_id FROM vrp_permissions WHERE permiss IN ('Verificado', 'VipDiamond') AND user_id=@user_id")