...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		['stock_capacity'] = 120000,				-- Maximum stock capacity
		['min_gas_price'] = 1,					-- Minimum price that the owner can apply
		...
		['ressuply_deliveryman'] = {					-- Driver contracts
			['max_amount'] = 1400,						-- Maximum amount of fuel per contract
			['price_per_liter'] = 4				        -- Standard price per contract liter
		},
		['ressuply'] = {								-- Definition of contracts for the owner
			...
			[3] = {
				['name'] = 'Large cargo',
				['price_per_liter_to_import'] = 2,
				['price_per_liter_to_export'] = 5,
				['liters'] = 700,
				['max_distance'] = 99,
				['truck_level'] = 5,
				['img'] = 'caminhao.png'
