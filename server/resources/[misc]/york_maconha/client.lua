...
local locais = { 
	...
	{ ['id'] = 1, ['x'] = 2224.79, ['y'] = 5578.72, ['z'] = 53.88, ['text'] = "colher a Sativa", ['perm'] = "Groove" },  
	{ ['id'] = 2, ['x'] = 2218.69, ['y'] = 5575.37, ['z'] = 53.72, ['text'] = "colher a Índica", ['perm'] = "Groove" },  
	{ ['id'] = 3, ['x'] =  116.47, ['y'] = 6362.53, ['z'] = 32.79, ['text'] = "preparar a bucha", ['perm'] = "Groove" },
}  
				...
				if IsControlJustPressed(0,38) and func.checkPermission(v.perm) then
					if v.id == 1 then
						if func.checkPayment(v.id) then
							TriggerEvent("Progress", 20000, "Colhendo...")
							processo = true
							SetEntityHeading(ped, 279.59)
