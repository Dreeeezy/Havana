Config = {
    Items = {
        ['lean'] = {
            name = 'Lean', 
            type = 'medical', -- links to drug presets.
            quality = 1.0,  -- quality of drug/effect strength modifier   float           (0.1 - 2.0)
            instant = true,  -- is effect instant?                         true or false
            sober = true,  -- does this effect cancel all other effects? true or false
            effects = {
    ...
    Presets = {
        trip = {{
            timecycle = 'Drug_deadman_blend', -- main timecycle modifier      false or string       (any timecycle filter)
            timecycle_min_strength = 0.7, -- timecycle max strength       false or float        (0.0 - 2.0)
            timecycle_max_strength = 2.0, -- timecycle max strength       false or float        (0.0 - 2.0)
            ...
            cam_shake_min_strength = 0.5, -- Cam shake min        false or float      (0.0 - 2.0)
            cam_shake_max_strength = 1.0, -- Cam shake max        false or float      (0.0 - 2.0)
            ...
            toon_count = 2, -- toons to draw?       false or int    (1 - 2)
            draw_box = 15, -- draw 3d box?         false or int    (1 - 30)
            play_song = 'C0i_HN8JhNU', -- play song during?    false or string (if using fivem-getwave, must be getwave file string (e.g: 'files/altar.mp3'), if not, must be youtube video ID)
            get_wave = false, -- use fivem-getwave?   true or false
            song_start = 0, -- start song at second int             (0 - SONG LENGTH)
            drunk_drive = true
        }, {
            timecycle = 'Drug_deadman_blend',
            timecycle_min_strength = 0.7,
    ...
    DrivingIncidents = { -- {interaction = 06, time = 1000},
    {
        interaction = 07,
        time = 800
    }, {
