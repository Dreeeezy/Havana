$('#shutdownbutton').click(function() {
    $.post('https://alta_carmusic/action', JSON.stringify({
        action: 'exit'
    }));
})
...
var vidname = "Nome não encontrado";
...
function getNameFile(url) {
	if (url == undefined) {
		vidname = "Nothing";
		document.getElementById("testrec").innerHTML = "<b>Tocando:</b><marquee direction = 'right'> "+ vidname + "</marquee>"
	} else {
