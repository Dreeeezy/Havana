...
local blips = {
	...
	{ 306.37,-588.44,43.71,80,38,"Hospital",0.5 },
	...
	{ 441.32,-983.29,30.69,60,29,"Departamento Policial",0.6 },
	...
	{ -1604.67,5256.91,2.08,266,4,"Embarcações",0.5 },
	...
	{ -118.22,6389.23,32.19,93,62,"Bar",0.5 },
	{ 81.03,-1555.93,29.6,318,62,"Lixeiro",0.6 },
	{ -429.08,-1728.02,19.79,467,2,"Reciclagem",0.6 },
	{ 94.76,-1507.05,29.26,467,2,"Reciclagem orgânico",0.6 },
--	{ 169.42,-1633.88,29.28,106,62,"Bishops",0.5 }, 
	{ 169.51,-1634.03,29.3,106,62,"Bishops",0.5 },
	{ 174.46,-1317.82,29.35,272,4,"Loja de Penhores",0.6 },
...
--	{ -364.24,6071.16,31.52,357,9,"Impound",0.6 },
	{ 547.39,-177.49,54.5,402,26,"Mecânica",0.7 },
...
--	{ 562.36,2741.56,42.87,273,11,"Animal Park",0.5 },
	{ -1591.54,-1006.16,13.02,68,62,"Pescador",0.5 },
	{ -1203.01,2714.0,4.98,68,3,"Pesca",0.5 },
	{ -1193.83,-891.0,14.0,106,4,"Burguer Shot",0.5 },
	{ 919.35,45.66,80.9,617,4,"Cassino",0.5 },
	{ -658.6,-854.81,24.52,521,3,"Digital Den",0.5 },
	{ 392.59,-831.76,29.3,521,2,"Assistencia Tecnica",0.5 },
	{ -1388.96,-585.54,30.22,93,4,"Bahamas",0.5 },	
	{ 241.08,-1378.91,33.75,84,4,"Necrotério",0.5 },
	{ -1042.67,5325.84,44.65,89,4,"Hortifruti",0.5 },
	{ -1195.12,-1577.45,4.61,126,3,"Academia",0.5 }, 
	{ -571.87,5338.1,70.22,238,3,"Lenhador",0.5 },
	{ 455.87,5571.93,781.19,550,3,"Paraquedismo",0.5 },
	{ -211.62,-1323.89,30.9,402,17,"Benny's",0.6 },
	{ -983.93,-2985.9,13.95,307,4,"Taxi Aéreo",0.5 },
	{ 237.81,-413.08,48.12,498,8,"Cartório",0.6 },
	{ 4.22,-706.58,45.98,351,17,"Advocacia",0.6 },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADBLIPS
-----------------------------------------------------------------------------------------------------------------------------------------
...
Citizen.CreateThread(function()
	...
	SetRadarZoom(1100)
	AddTextEntry("FE_THDR_GTAO","Havana City")
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADGLOBAL - 10
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
local teleport = {
	{ 330.19,-601.21,43.29,345.9,-582.67,28.8 }, ---Hospital PhilBox
	{ 345.9,-582.67,28.8,330.46,-601.08,43.29 },

	{ 327.16,-603.53,43.29,338.97,-583.85,74.16 },
	{ 338.97,-583.85,74.16,327.16,-603.53,43.29 },

	{ 936.02,47.21,81.1,1089.62,205.88,-49.0 }, ---Cassino
	{ 1089.62,205.88,-49.0,936.02,47.21,81.1 },

	{ 1119.32,267.24,-45.84,965.03,58.41,112.56 },
	{ 965.03,58.41,112.56,1119.32,267.24,-45.84 },
	...
	{ 4.58,-705.95,45.98,-139.85,-627.0,168.83 }, --- advogados
	...
	{ 110.69,-1297.02,29.27,126.98,-1277.64,29.35 }, --- Vanilla
	{ 126.98,-1277.64,29.35,110.69,-1297.02,29.27 },
	
	{ 241.14,-1378.93,33.75,275.8,-1361.48,24.54 }, -- necroterio
	{ 275.8,-1361.48,24.54,241.14,-1378.93,33.75 },

	{ 139.04,-762.67,45.76,136.31,-761.56,242.16 }, ---Fib
	{ 136.31,-761.56,242.16,139.04,-762.67,45.76 },

	{ 457.26,5571.98,781.19,1773.05,6225.83,2699.94 },  ---paraquedas
	{ 1773.05,6225.83,2699.94,457.26,5571.98,781.19 },

	{ 232.89,-411.39,48.12,224.63,-360.7,-98.78 },-- cartorio
	{ 224.63,-360.7,-98.78,232.89,-411.39,48.12 },

	{ 234.33,-387.57,-98.78,244.34,-429.14,-98.78 }, --cartorio
	{ 244.34,-429.14,-98.78,234.33,-387.57,-98.78 },

	{ -469.74,43.17,46.24,-471.9,43.49,46.24 }, --galeria de artes
	{ -471.9,43.49,46.24,-469.74,43.17,46.24 },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADHOVERFY
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
-- REMOVER ARMA ACIMA DE 70KM DENTRO DO CARRO
-----------------------------------------------------------------------------------------------------------------------------------------
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(1000)
...
Citizen.CreateThread( function()
	while true do
		...
		if ( ped ) then
			if math.floor(speed*3.6) == 260 then --Velocidade limitada em 260
