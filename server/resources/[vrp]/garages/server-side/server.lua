...
local garages = {
	...
	[19] = { ["name"] = "Paramedico", ["payment"] = false, ["perm"] = "Paramedico" },
	[20] = { ["name"] = "Heliparamedic", ["payment"] = false, ["perm"] = "Paramedico" },
	[21] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Policia" },
	[22] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Policia" },
	[23] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Policia" },
	[24] = { ["name"] = "HeliPolice", ["payment"] = false, ["perm"] = "Policia" },
	[25] = { ["name"] = "HeliPolice", ["payment"] = false, ["perm"] = "Policia" },
	[26] = { ["name"] = "HeliPolice", ["payment"] = false, ["perm"] = "Policia" },
...
--	[37] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[38] = { ["name"] = "Prison", ["payment"] = false, ["perm"] = "Policia" },
...
--	[42] = { ["name"] = "Taxi", ["payment"] = false, ["public"] = true },
	...
	[44] = { ["name"] = "Airforce", ["payment"] = false, ["public"] = true },
	[46] = { ["name"] = "Trucker", ["payment"] = false, ["public"] = true },
	...
	[759] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Policia" },
--	[760] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
--	[761] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[762] = { ["name"] = "Goldminer", ["payment"] = false, ["public"] = true },
	[763] = { ["name"] = "Avalanches", ["payment"] = false, ["perm"] = "Avalanches" },
	[764] = { ["name"] = "Kart", ["payment"] = false, ["perm"] = false },
	[765] = { ["name"] = "Mecanico", ["payment"] = false, ["perm"] = "Mecanico" },
	[766] = { ["name"] = "Bahamas", ["payment"] = false, ["perm"] = "Bahamas" },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- GARAGES
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	if user_id and name then
        if not vCLIENT.returnVehicle(source,name) then
			...
			if parseInt(os.time()) <= parseInt(vehicle[1].time+24*60*60) then
				...
				if status then
					if vRP.havanaPay(user_id,parseInt(vRP.vehiclePrice(name)*0.5)) then
			...
			elseif parseInt(vehicle[1].arrest) >= 1 then
				...
				if status then
					if vRP.havanaPay(user_id,parseInt(vRP.vehiclePrice(name)*0.1)) then
						vRP.execute("vRP/set_arrest",{ user_id = parseInt(user_id), vehicle = name, arrest = 0, time = 0 })
					else
						TriggerClientEvent("Notify",source,"vermelho","Dinheiro insuficiente.",5000)
					end
				...
				if garages[use].payment and not vRP.getPremium(parseInt(user_id)) then
					if vRP.getBank(parseInt(user_id)) >= parseInt(vRP.vehiclePrice(name)*0.05) then
						...
						if status and vRP.havanaPay(parseInt(user_id),parseInt(vRP.vehiclePrice(name)*0.05)) then
