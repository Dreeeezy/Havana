...
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local records = "https://discord.com/api/webhooks/890054736752017440/3MEiLWWoPnMIa-R5Hmvc2kHzzawX0jIJcjOY_R6Bq9GhCupOhRqTxHfNZP8npdbSrsBE"
local fines = "https://discord.com/api/webhooks/890054612541898782/T-yWiYCwjAZs6nbxauCjGVwnTlHynnQ8qLG8YS7VHTs3jl6xBveU2zPwJbJg2qQalhzk"
-----------------------------------------------------------------------------------------------------------------------------------------
-- PRISON
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("vRP:playerSpawn",function(user_id,source)
	...
	if parseInt(consult[1].prison) <= 0 then
		...
		vRP.giveInventoryItem(nplayer,"water",2)
		vRP.giveInventoryItem(nplayer,"sandwich",2)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- FINE
