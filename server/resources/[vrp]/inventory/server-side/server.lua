			...
			if inv then
				...
				if vRP.itemTypeList(itemName) == "use" then
					...
					if itemName == "bandage" then
						if vRPclient.getHealth(source) > 101 and vRPclient.getHealth(source) < 170 then
							active[user_id] = 10
					...
					if itemName == "nbcellphone" then
						if vRP.getInventoryItemAmount(user_id,"nbcellphone") >= parseInt(rAmount) and vRP.getInventoryItemAmount(user_id,"cellbattery") >= parseInt(rAmount) then
						active[user_id] = parseInt(rAmount*3)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,parseInt(rAmount*3000),"Utilizando...")
						...
						repeat
							if active[user_id] == 0 then
								...
								vCLIENT.blockButtons(source,false)
									...
									if vRP.tryGetInventoryItem(user_id,"nbcellphone",parseInt(rAmount),true,slot) and vRP.tryGetInventoryItem(user_id,"cellbattery",parseInt(rAmount),true) then
										vRP.giveInventoryItem(user_id,"cellphone",parseInt(rAmount),true)
									end
								end
								Citizen.Wait(0)
							until active[user_id] == nil
						else
							TriggerClientEvent("Notify",source,"vermelho","Você não tem uma bateria.",5000)
						end
					end

					if itemName == "nbtablet" then
						if vRP.getInventoryItemAmount(user_id,"nbtablet") >= parseInt(rAmount) and vRP.getInventoryItemAmount(user_id,"tabletbattery") >= parseInt(rAmount) then
						active[user_id] = parseInt(rAmount*3)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,parseInt(rAmount*3000),"Utilizando...")
						...
						repeat
							if active[user_id] == 0 then
								...
								vCLIENT.blockButtons(source,false)
									...
									if vRP.tryGetInventoryItem(user_id,"nbtablet",parseInt(rAmount),true,slot) and vRP.tryGetInventoryItem(user_id,"tabletbattery",parseInt(rAmount),true) then
										vRP.giveInventoryItem(user_id,"tablet",parseInt(rAmount),true)
									end
								end
								Citizen.Wait(0)
							until active[user_id] == nil
					...
					if itemName == "nbradio" then
						if vRP.getInventoryItemAmount(user_id,"nbradio") >= parseInt(rAmount) and vRP.getInventoryItemAmount(user_id,"radiobattery") >= parseInt(rAmount) then
						active[user_id] = parseInt(rAmount*3)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,parseInt(rAmount*3000),"Utilizando...")
						...
						repeat
							if active[user_id] == 0 then
								...
								vCLIENT.blockButtons(source,false)
									...
									if vRP.tryGetInventoryItem(user_id,"nbradio",parseInt(rAmount),true,slot) and vRP.tryGetInventoryItem(user_id,"radiobattery",parseInt(rAmount),true) then
										vRP.giveInventoryItem(user_id,"radio",parseInt(rAmount),true)
									end
								end
								Citizen.Wait(0)
							until active[user_id] == nil
					...
					if itemName == "cocaine" then
						if vRP.getInventoryItemAmount(user_id,"cocaine") >= parseInt(rAmount) and vRP.getInventoryItemAmount(user_id,"pin") >= parseInt(rAmount) then
						active[user_id] = parseInt(rAmount*1)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,parseInt(rAmount*1000),"Utilizando...")
						...
						repeat
							if active[user_id] == 0 then
								...
								vCLIENT.blockButtons(source,false)
									...
									if vRP.tryGetInventoryItem(user_id,"cocaine",parseInt(rAmount),true,slot) and vRP.tryGetInventoryItem(user_id,"pin",parseInt(rAmount),true) then
										vRP.giveInventoryItem(user_id,"cocainepin",parseInt(rAmount),true)
									end
								end
								Citizen.Wait(0)
							until active[user_id] == nil
						else
							TriggerClientEvent("Notify",source,"vermelho","Você não tem um pino.",5000)
						end
					end

					if itemName == "xaropelean" then
						if vRP.getInventoryItemAmount(user_id,"xaropelean") >= parseInt(rAmount) and vRP.getInventoryItemAmount(user_id,"emptyglassbottle") >= parseInt(rAmount) then
						active[user_id] = parseInt(rAmount*1)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,parseInt(rAmount*1000),"Utilizando...")
						...
						repeat
							if active[user_id] == 0 then
								...
								vCLIENT.blockButtons(source,false)
									...
									if vRP.tryGetInventoryItem(user_id,"xaropelean",parseInt(rAmount),true,slot) and vRP.tryGetInventoryItem(user_id,"emptyglassbottle",parseInt(rAmount),true) then
										vRP.giveInventoryItem(user_id,"lean",parseInt(rAmount),true)
									end
								end
								Citizen.Wait(0)
							until active[user_id] == nil
						else
							TriggerClientEvent("Notify",source,"vermelho","Você não tem uma Garrafa de vidro vazia.",5000)
						end
					end

					if itemName == "crystalmeth" then
						if vRP.getInventoryItemAmount(user_id,"crystalmeth") >= parseInt(rAmount) and vRP.getInventoryItemAmount(user_id,"plasticbag") >= parseInt(rAmount) then
						active[user_id] = parseInt(rAmount*1)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,parseInt(rAmount*1000),"Utilizando...")
						...
						repeat
							if active[user_id] == 0 then
								...
								vCLIENT.blockButtons(source,false)
									...
									if vRP.tryGetInventoryItem(user_id,"crystalmeth",parseInt(rAmount),true,slot) and vRP.tryGetInventoryItem(user_id,"plasticbag",parseInt(rAmount),true) then
										vRP.giveInventoryItem(user_id,"meth",parseInt(rAmount),true)
									end
								end
								Citizen.Wait(0)
							until active[user_id] == nil
						else
							TriggerClientEvent("Notify",source,"vermelho","Você não tem um saco plástico.",5000)
						end
					end

					if itemName == "mdma" then
						if vRP.getInventoryItemAmount(user_id,"mdma") >= parseInt(rAmount) and vRP.getInventoryItemAmount(user_id,"plasticbag") >= parseInt(rAmount) then
						active[user_id] = parseInt(rAmount*1)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,parseInt(rAmount*1000),"Utilizando...")
						...
						repeat
							if active[user_id] == 0 then
								...
								vCLIENT.blockButtons(source,false)
									...
									if vRP.tryGetInventoryItem(user_id,"mdma",parseInt(rAmount),true,slot) and vRP.tryGetInventoryItem(user_id,"plasticbag",parseInt(rAmount),true) then
										vRP.giveInventoryItem(user_id,"ecstasy",parseInt(rAmount),true)
									end
								end
								Citizen.Wait(0)
							until active[user_id] == nil
					...
					if itemName == "ecstasy" then
						...
						local itemdrug = exports['mf-drugfx']:GetTableItem("ecstasy")

						TriggerEvent("Drugs:Consume",source, itemdrug)
					end
					...
					if itemName == "meth" then
						...
						local itemdrug = exports['mf-drugfx']:GetTableItem("meth")

						TriggerEvent("Drugs:Consume",source, itemdrug)
					end
					
					if itemName == "cocainepin" then
						vCLIENT.closeInventory(source)
						TriggerClientEvent("Progress",source,6000,"Utilizando...")
						if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
						end

						local itemdrug = exports['mf-drugfx']:GetTableItem("cocaine")

						TriggerEvent("Drugs:Consume",source, itemdrug)
					end

					if itemName == "ifak" then
						vCLIENT.closeInventory(source)
						TriggerClientEvent("Progress",source,6000,"Utilizando...")
						if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
						end

						local itemdrug = exports['mf-drugfx']:GetTableItem("ifak")

						TriggerEvent("Drugs:Consume",source, itemdrug)
					end

					if itemName == "havana" then
						vCLIENT.closeInventory(source)
						TriggerClientEvent("Progress",source,6000,"Utilizando...")
						if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
						end

						local itemdrug = exports['mf-drugfx']:GetTableItem("havana")
					...
					if itemName == "warfarin" then
						if vRPclient.getHealth(source) > 101 and vRPclient.getHealth(source) < 170 then
							...
							vCLIENT.closeInventory(source)
							vCLIENT.blockButtons(source,true)
							TriggerClientEvent("Progress",source,16000,"Utilizando...")
							...
							repeat
								if active[user_id] == 0 then
									...
									if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
										vRPclient.updateHealth(source,30)
					...
					if itemName == "portec" then
						local nplayer = vRPclient.nearestPlayer(source,2)
						if nplayer then
							local identity = vRP.getUserIdentity(user_id)
							if identity then
								TriggerClientEvent("Notify",nplayer,"importante","<b>Passaporte:</b> "..vRP.format(parseInt(identity.id)).."<br><b>Nome:</b> "..identity.name.." "..identity.name2.."<br><b>RG:</b> "..identity.registration.."<br><b>Telefone:</b> "..identity.phone.."<br><b>Porte de Armas: Civil</b> ",10000)
							end
						end
					end

					if itemName == "portef" then
						local nplayer = vRPclient.nearestPlayer(source,2)
						if nplayer then
							local identity = vRP.getUserIdentity(user_id)
							if identity then
								TriggerClientEvent("Notify",nplayer,"importante","<b>Passaporte:</b> "..vRP.format(parseInt(identity.id)).."<br><b>Nome:</b> "..identity.name.." "..identity.name2.."<br><b>RG:</b> "..identity.registration.."<br><b>Telefone:</b> "..identity.phone.."<br><b>Porte de Armas: Fazendeiro</b> ",10000)
							end
						end
					end

					if itemName == "portes" then
						local nplayer = vRPclient.nearestPlayer(source,2)
						if nplayer then
							local identity = vRP.getUserIdentity(user_id)
							if identity then
								TriggerClientEvent("Notify",nplayer,"importante","<b>Passaporte:</b> "..vRP.format(parseInt(identity.id)).."<br><b>Nome:</b> "..identity.name.." "..identity.name2.."<br><b>RG:</b> "..identity.registration.."<br><b>Telefone:</b> "..identity.phone.."<br><b>Porte de Armas: Caçador</b> ",10000)
							end
						end
					end

					if itemName == "hardness" then
						vRPclient.stopActived(source)
						vCLIENT.closeInventory(source)
						TriggerClientEvent("hud:allHardness",source)
					end
...
--									TriggerClientEvent("Notify",source,"vermelho","Você infelizmente falhou.",5000)
					...
					if itemName == "chandon" then
						...
						local itemdrug = exports['mf-drugfx']:GetTableItem("beer")
					...
					if itemName == "descartavel1" then
						...
						repeat
							if active[user_id] == 0 then
								...
								if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
									vRP.giveInventoryItem(user_id,"descartavel2",1)
								end
							end
							Citizen.Wait(0)
						until active[user_id] == nil
						TriggerClientEvent("products:delivery",source)
					end

					if itemName == "descartavel2" then
						active[user_id] = 1
						vRPclient.stopActived(source)
						vCLIENT.closeInventory(source)repeat
							if active[user_id] == 0 then
								active[user_id] = nil
								vCLIENT.blockButtons(source,false)
								vRPclient._removeObjects(source,"one")
					...
					if itemName == "fishingrod" then
                        if vCLIENT.fishingStatus(source) then
                            ...
                            if vTASKBAR.taskFishing(source) then
                                ...
                                local fishs = { "goldenfish","horsefish","carp","pirarucu","tilapia","catfish","codfish" }
					...
					if itemName == "grape" then
						active[user_id] = 7
						vRPclient.stopActived(source)
						vCLIENT.closeInventory(source)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,7000,"Utilizando...")
						vRPclient._createObjects(source,"mp_player_inteat@burger","mp_player_int_eat_burger","",49,60309)
					...
					if itemName == "macarronada" then
						active[user_id] = 15
						vRPclient.stopActived(source)
						vCLIENT.closeInventory(source)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,15000,"Utilizando...")
						vRPclient._createObjects(source,"mp_player_inteat@burger","mp_player_int_eat_burger","v_ret_fh_noodle",49,60309)
					...
					if itemName == "xtorpedo" then
						active[user_id] = 10
						vRPclient.stopActived(source)
						vCLIENT.closeInventory(source)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,10000)
						vRPclient._createObjects(source,"mp_player_inteat@burger","mp_player_int_eat_burger","prop_food_bs_burger2",49,60309)
					...
					if itemName == "lamen" then
						...
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,10000)
						vRPclient._createObjects(source,"mp_player_inteat@burger","mp_player_int_eat_burger","prop_cs_bowl_01b",49,60309)
					...
					if itemName == "amendoim" then
						active[user_id] = 10
						vRPclient.stopActived(source)
						vCLIENT.closeInventory(source)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,10000)
						vRPclient._createObjects(source,"mp_player_inteat@burger","mp_player_int_eat_burger","prop_food_cb_donuts",49,60309)
					...
					if itemName == "ovo" then
						active[user_id] = 10
						vRPclient.stopActived(source)
						vCLIENT.closeInventory(source)
						vCLIENT.blockButtons(source,true)
						TriggerClientEvent("Progress",source,10000)
						vRPclient._createObjects(source,"mp_player_inteat@burger","mp_player_int_eat_burger","v_ret_247_eggs",49,18905,0.13,0.05,0.02,-50.0,16.0,60.0)
					...
					if itemName == "compost" then
						...
						if homeEnter == "" then
							...
							--[[ local weCounts = exports.weplants:getAmount(user_id)
								...
								if status and vRP.getInventoryItemAmount(user_id,"bucket") >= 1 then
									...
									repeat
										if active[user_id] == 0 then
											...
											if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) and vRP.tryGetInventoryItem(user_id,"bucket",1,true) and vRP.tryGetInventoryItem(user_id,"cannabisseed",1,true) then
					...
					if itemName == "premiumplate" then
						...
						if vehicle[1] then
							...
							if vehPlate == "" or string.upper(vehPlate) == "Havana-City" then
								return
							end
					...
					if itemName == "chip" then
						vCLIENT.closeInventory(source)
						if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
							vRP.execute("vRP/update_celular",{ id = user_id, phone = vRP.generatePhoneNumber() })
						end
					end
					...
					if itemName == "pretreino" then
						...
						repeat
							if active[user_id] == 0 then
								...
								if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
									vRP.chemicalTimer(user_id,2)
									TriggerClientEvent("setEnergetic",source,20,1.45)
								end
							end
							Citizen.Wait(0)
						until active[user_id] == nil
						...
						if identity then
							if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
								if not vRP.getPremium(user_id) then
									vRP.execute("vRP/set_premium",{ steam = identity.steam, premium = parseInt(os.time()), predays = 30, priority = 5 })
								else
					...
					if itemName == "premium02" then
						...
						if identity then
							if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
								if not vRP.getPremium(user_id) then
									vRP.execute("vRP/set_premium",{ steam = identity.steam, premium = parseInt(os.time()), predays = 30, priority = 10 })
								else
									vRP.execute("vRP/update_premium",{ steam = identity.steam, predays = 30 })
								end
							end
					...
					if itemName == "premium04" then
						...
						if identity then
							if vRP.tryGetInventoryItem(user_id,itemName,1,true,slot) then
								if not vRP.getPremium(user_id) then
									vRP.execute("vRP/set_premium",{ steam = identity.steam, premium = parseInt(os.time()), predays = 30, priority = 35 })
								else
									vRP.execute("vRP/update_premium",{ steam = identity.steam, predays = 30 })
								end
							end
					...
					if itemName == "pager" then
						...
						if nplayer then
							local nuser_id = vRP.getUserId(nplayer)
							if nuser_id then
								if vRP.hasPermission(nuser_id,"Policia") then
									TriggerClientEvent("radio:outServers",nplayer)
									TriggerEvent("blipsystem:serviceExit",nplayer)
									vRP.removePermission(vRP.getUserSource(nuser_id),"Policia")
									vRP.execute("vRP/upd_group",{ user_id = nuser_id, permiss = "Policia", newpermiss = "waitPolice" })
				...
				if vRP.itemTypeList(itemName) == "equip" then
					...
					local rifles =      {"WEAPON_ASSAULTRIFLE", "WEAPON_ASSAULTRIFLE_MK2", "WEAPON_CARBINERIFLE","WEAPON_CARBINERIFLE_MK2","WEAPON_ADVANCEDRIFLE", "WEAPON_SPECIALCARBINE","WEAPON_SPECIALCARBINE_MK2","WEAPON_BULLUPRIFLE","WEAPON_BULLUPRIFLE_MK2","WEAPON_COMPACTRFILE","WEAPON_MILITARYRIFLE","WEAPON_SNOWBALL"}
...
AddEventHandler("vrp_itemdrop:Create",function(item,count,x,y,z,source,durability)
    local id = idgens:gen()
    droplist[id] = { item = item, count = count, x = x, y = y, z = z, economy = vRP.itemEconomyList(item), tipo = vRP.itemTipoList(item), unity = vRP.itemUnityList(item), desc = vRP.itemDescList(item), name = vRP.itemNameList(item), durability = durability,  index = vRP.itemIndexList(item), peso = vRP.itemWeightList(item) }
    TriggerClientEvent("itemdrop:Players",-1,id,droplist[id])
	TriggerClientEvent("inventory:Update",source,"updateMochila") -- try
	...
	vCLIENT.closeInventory(source)
        if droplist[id].count - amount >= 1 then 
			if vRP.itemSubTypeList(droplist[id].item) then
				if (vRP.getInventoryItemAmount(user_id,droplist[id].item) + amount) > vRP.itemMaxAmount(droplist[id].item) then
					TriggerClientEvent("Notify",source,"vermelho","Você já possui esse tipo de item ou atingiu o limite.",5000)
					TriggerClientEvent("inventory:Update",source,"updateMochila")
					vCLIENT.closeInventory(source)
					return
				else
