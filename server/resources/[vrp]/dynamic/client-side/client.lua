	...
	if not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not menuOpen then
		...
		if GetEntityHealth(ped) > 101 then
			...
			if not IsPedInAnyVehicle(ped) then
				...
				exports["dynamic"]:AddButton("Colocar no Veículo","Colocar no veículo mais próximo.","player:putVehicle","2","otherPlayers",true)
				exports["dynamic"]:AddButton("Remover do Veículo","Remover do veículo mais próximo.","player:removeVehicle","rv","otherPlayers",true)
	...
	if policeService or paramedicService then
		if not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not menuOpen then
			...
			if GetEntityHealth(ped) > 101 then
				...
				if not IsPedInAnyVehicle(ped) then
					exports["dynamic"]:AddButton("Carregar pelos Braços","Carregar a pessoa mais próxima.","player:toggleCarry","bracos","player",true)
					exports["dynamic"]:AddButton("Carregar nos Ombros","Carregar a pessoa mais próxima.","rope:toggleRope","ombros","player",true)
