...
-----------------------------------------------------------------------------------------------------------------------------------------
cnVRP = {}
Tunnel.bindInterface("paramedic",cnVRP)
...
RegisterCommand("re",function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.hasPermission(user_id,"Paramedico") or vRP.hasPermission(user_id,"Policia") then
...
RegisterNetEvent("paramedico:reanimar")
AddEventHandler("paramedico:reanimar", function(source)
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.hasPermission(user_id,"Paramedico") or vRP.hasPermission(user_id,"Policia") then
			local nplayer = vRPclient.nearestPlayer(source,2)
