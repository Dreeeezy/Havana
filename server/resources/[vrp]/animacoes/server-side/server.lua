...
RegisterCommand('e',function(source,args,rawCommand)
	...
	if nplayer and not vRPclient.isInVehicle(nplayer) and not vRPclient.isHandcuffed(nplayer) and vRPclient.getHealth(nplayer) > 101 then
		if args[1] == "beijar" then
			if vRP.request(nplayer,"Deseja beijar <b>"..identity.name.." "..identity.name2.."</b> ?",5) then
		...
		elseif args[1] == "abracar" then
			if vRP.request(nplayer,"Deseja abraçar <b>"..identity.name.." "..identity.name2.."</b> ?",5) then
		...
		elseif args[1] == "dancar257" then
			if vRP.request(nplayer,"Deseja dançar com <b>"..identity.name.." "..identity.name2.."</b> ?",5) then
		...
		elseif args[1] == "casal" then
			if vRP.request(nplayer,"Deseja casal com <b>"..identity.name.." "..identity.name2.."</b> ?",5) then
...
RegisterCommand('e2',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"Admin") or vRP.hasPermission(user_id,"Paramedico") then
