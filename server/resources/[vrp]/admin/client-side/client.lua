...
function cRP.setDiscord(status)
	SetDiscordAppId(897243219253952512) SetRichPresence('discord.gg/ZVgaWEM8Xf')
	SetDiscordRichPresenceAsset('havanaicon')
	SetDiscordRichPresenceAssetText('discord.gg/ZVgaWEM8Xf')
	SetDiscordRichPresenceAssetSmallText('Havana City')
	SetDiscordRichPresenceAction(0, "Conectar!", "fivem://connect/havanaroleplay.com.br")
	SetDiscordRichPresenceAction(1, "Site!", "https://havanacity.com.br/")
...
Citizen.CreateThread(function()
    while true do
        ...
        if z < -110 then
            if IsPedInAnyVehicle(ped) then
                 vSERVER.deleteVehicle(GetVehiclePedIsIn(ped))
