...
-----------------------------------------------------------------------------------------------------------------------------------------
local locateShops = {
	{ 75.40,-1392.92,29.37 }, --LOJA DE ROUPAS
	{ -709.40,-153.66,37.41 },
	{ -163.20,-302.03,39.73 },
	{ 425.58,-806.23,29.49 },
	...
	{ -1101.46,2710.57,19.10 }, --LOJA DE ROUPAS
	{ 457.36,-990.72,30.69 }, -- Police
	{ 132.53,-769.39,242.16 }, --FIB
	{ -238.66,-1337.17,30.89 }, -- BENNYS
	{ -238.85,-1339.47,30.89 }, -- BENNYS
	{ 2092.68,3419.47,47.44 }, -- AMARELOS
	{ 2136.47,3473.88,51.74 }, -- AMARELOS
	{ 975.46,65.2,116.17 }, -- Bahamas
	{ 958.06,-2390.6,22.33 }, --Tunning
	{ 992.23,-135.86,74.07 }, -- Motoclub 
	{ 118.29,-2008.35,18.31 }, -- Guetto Ballas
	{ -1514.98,107.91,52.25 }, -- MASAO PLAYBOY
	{ -76.61,1008.16,239.48 },-- Mansão Edicola
	{ -60.41,994.43,239.52 },-- Mansão Edicola
	{ -671.59,587.36,141.57 },-- Tripléx
	{ -66.95,828.22,231.33 }, -- MAFIA YAKUZA 
	{ 550.43,-181.85,54.5 }, -- LS CUSTOM - BACO
	{ -430.18,15.31,35.03 }, --Bratva
	{ -1476.3,-26.41,54.66 }, -- Triade
	{ -1797.78,430.14,132.26 }, -- Castelo
	{ -1795.41,420.41,132.26 }, -- Castelo 
	{ -1793.37,438.19,132.26 }, --Castelo 1
	{ -118.79,6373.15,32.19 }, --Mojito (Vagos)
	{ -1887.22,2070.11,145.58 }, -- Vinhedo
	{ 300.3,-598.69,43.29 } -- PillBox
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADHOVERFY
-----------------------------------------------------------------------------------------------------------------------------------------
Citizen.CreateThread(function()
	...
	for k,v in pairs(locateShops) do
		table.insert(innerTable,{ v[1],v[2],v[3],2.5,"E","Loja de Roupas","Pressione para abrir" })
	end
