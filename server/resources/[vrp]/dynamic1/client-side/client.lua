...
RegisterCommand("globalFunctions",function(source,args)
	if not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not menuOpen then
		...
		if GetEntityHealth(ped) > 101 then
			...
			exports["dynamic"]:AddButton("Procurado","Verifica seu tempo de procurado.","vrp:wantedFunctions","","others",true)
			exports["dynamic"]:AddButton("Repouso","Verifica seu tempo de repouso.","vrp:reposeFunctions","","others",true)
