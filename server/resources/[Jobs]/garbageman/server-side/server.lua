...
function cRP.paymentMethod(garbageId)
	...
	if user_id then
		...
		elseif parseInt(random) >= 3 and parseInt(random) <= 86 then
			vRP.giveInventoryItem(user_id,"paper",math.random(3),true)
		elseif parseInt(random) >= 1 and parseInt(random) <= 86 then
			vRP.giveInventoryItem(user_id,"abobora",math.random(3),true)
		end
