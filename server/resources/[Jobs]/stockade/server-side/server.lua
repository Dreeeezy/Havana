	...
	if user_id then
		if stockadePlates[vehPlate] == nil then
			...
			if stockadePlates[vehPlate] > 0 then
				vRP.wantedTimer(user_id,150) -- old is 30, need try
				...
				vRP.giveInventoryItem(user_id,"dollars2",math.random(3500,4800),true)
			else
